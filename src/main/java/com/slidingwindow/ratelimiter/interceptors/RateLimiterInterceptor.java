package com.slidingwindow.ratelimiter.interceptors;

import com.slidingwindow.ratelimiter.helper.UserRequestData;
import com.slidingwindow.ratelimiter.service.SubscriptionService;
...
public class RateLimiterInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        UserRequestData userRequestData = subscriptionService.resolveSubscribedUserData(subscriptionKey);
